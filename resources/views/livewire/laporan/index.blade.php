                                ...
                                <div class="d-flex justify-content-between">
                                    <div id="subject-col-1" style="width: 100%">
                                        <p class="strong mb-1">{{ $item['subject'] }}<span
                                                id="badge-status-{{ $i }}"
                                                class="badge {{ $item['status'] === '0' ? 'bg-red' : ($item['status'] === 'proses' ? 'bg-yellow' : 'bg-green') }} ms-2">{{ $item['status'] === '0' ? 'Belum di proses' : Str::title($item['status']) }}</span>
                                        </p>
                                                    ...
                                                    <form method="POST">
                                                        ...
                                                        <div class="d-flex justify-content-end gap-2 pt-2">
                                                            ...
                                                            <button class="btn btn-sm btn-success" id="terima"
                                                                name="terima" value="{{ $item['tgl_pengaduan'] }}">Terima
                                                                &
                                                                Kirim</button>
